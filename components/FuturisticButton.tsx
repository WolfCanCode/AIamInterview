...
export default function FuturisticButton({
  ...
  return (
    <button
      className={`group relative w-full px-8 py-4 rounded-xl font-bold text-lg shadow-lg mt-4 overflow-hidden transition-all duration-300 transform ${c.bg} border ${c.border} ${c.text} ${c.shadow} backdrop-blur-xl focus:outline-none ${c.ring} hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
      {...props}
    >

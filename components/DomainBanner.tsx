...
export default function DomainBanner({
  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto bg-gray-900/95 rounded-xl sm:rounded-2xl shadow-2xl p-3 sm:p-8 flex flex-col items-center gap-4 sm:gap-6 animate-fade-in">
      {/* Back Button */}
      <button
        onClick={onBack}

...
export default function EvaluationCard({
  ...
  return (
    <div
      ref={evaluationRef}
      className="bg-gradient-to-br from-gray-900/90 to-gray-800/90 p-3 sm:p-8 rounded-xl sm:rounded-3xl shadow-2xl space-y-6 sm:space-y-8 animate-fade-in overflow-hidden border border-gray-700/60 w-full max-w-5xl mx-auto"
    >
